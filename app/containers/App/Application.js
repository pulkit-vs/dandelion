    ...
    return (
      <Dashboard history={history} changeMode={changeMode}>
        <Switch>
          ...
          <Route path='/projects/backlog' component={BacklogView} />
          ...
          <Route path='/dashboards/view-all-dashboards' component={ViewDashboard} />
          <Route path='/dashboards/create-dashboard' component={CreateDashboard} />
          ...
          <Route path='/filters/advanced-issue-search' component={AdvanceIssueSearchFilter} />
