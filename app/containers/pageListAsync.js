...
// Dashboard
export const PersonalDashboard = loadable(() => import('./Dashboard/PersonalDashboard'), {
  fallback: <Loading />,
});
...
export const DoughnutCharts = loadable(() => import('./Charts/DoughnutCharts'), {
  fallback: <Loading />,
});
...
export const LineScatterChart = loadable(() => import('./Charts/LineScatterChart'), {
  fallback: <Loading />,
});

export const AreaFilledChart = loadable(() => import('./Charts/AreaFilledChart'), {
  fallback: <Loading />,
});

export const RadarPolarCharts = loadable(() => import('./Charts/RadarPolarCharts'), {
  fallback: <Loading />,
});
...
export const ProjectHome = loadable(() => import('../src/projects/project-home'), {
  fallback: <Loading />,
});

export const AssignedToMe = loadable(() => import('../src/my-work/assigned-tasks'), {
  fallback: <Loading />,
});

export const AddProject = loadable(() => import('../src/projects/add-project'), {
  fallback: <Loading />,
});

export const StarredTasks = loadable(() => import('../src/my-work/starred-tasks'), {
  fallback: <Loading />,
});

export const CreateIssues = loadable(() => import('../src/issues/create-issue'), {
  fallback: <Loading />,
});
...
export const ManageSubscriptionsAccessSetting = loadable(
  () => import('../src/settings/user-management/subscriptions/manage-subscriptions'),
  {
    fallback: <Loading />,
  }
);
...
export const DiscoverApplicationsAccessSetting = loadable(
  () => import('../src/settings/user-management/subscriptions/discover-applications'),
  {
    fallback: <Loading />,
  }
);
...
export const KaryaSoftwareConfigurationSetting = loadable(
  () => import('../src/settings/product/karya-software/karya-software-configuration'),
  {
    fallback: <Loading />,
  }
);
...
//Filters
export const AdvanceIssueSearchFilter = loadable(() => import('../src/filters/advance-issue-search'), {
  fallback: <Loading />,
});

export const ViewAllFilters = loadable(() => import('../src/filters/advance-issue-search'), {
  fallback: <Loading />,
});

//Dashboards
export const CreateDashboard = loadable(() => import('../src/dashboard/create-dashboard'), {
  fallback: <Loading />,
});

export const ViewDashboard = loadable(() => import('../src/dashboard/view-dashboard'), {
  fallback: <Loading />,
});

export const BacklogView = loadable(() => import('../src/projects/backlog-view'), {
  fallback: <Loading />,
});
